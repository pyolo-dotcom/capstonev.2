    ...
    <div class="otp-card">
        ...
        <form method="POST" action="{{ route('verify.otp') }}" class="otp-form" id="otpForm">
            ...
            <div class="otp-input-container">
                <input type="tel" inputmode="numeric" pattern="\d*" maxlength="1" class="otp-input" name="otp1" required>
                <input type="tel" inputmode="numeric" pattern="\d*" maxlength="1" class="otp-input" name="otp2" required>
                <input type="tel" inputmode="numeric" pattern="\d*" maxlength="1" class="otp-input" name="otp3" required>
                <input type="tel" inputmode="numeric" pattern="\d*" maxlength="1" class="otp-input" name="otp4" required>
                <input type="tel" inputmode="numeric" pattern="\d*" maxlength="1" class="otp-input" name="otp5" required>
                <input type="tel" inputmode="numeric" pattern="\d*" maxlength="1" class="otp-input" name="otp6" required>
            </div>
