    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="managerChangePasswordForm" action="{{ route('manager.profile.change-password') }}" method="POST">
                    @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const form = document.getElementById('managerChangePasswordForm');
    if (form) {
