...
<li><a href="{{route ('manager.deliveryrecords')}}">Delivery Records</a></li>
<li><a href="{{route ('manager.managetrip')}}">Manage Trip Records</a></li>
<li><a href="{{route ('manager.gpscontrol')}}">GPS Control</a></li>
<li><a href="{{route ('manager.fuel')}}">Fuel Management</a></li>
<ul>
    <li>
