    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="driverChangePasswordForm" action="{{ route('driver.profile.change-password') }}" method="POST">
                    @csrf
                    
                    <!-- Dynamic alerts will be inserted here -->
                    <div id="passwordChangeAlerts" class="mb-3 mx-2"></div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            const alertsContainer = document.getElementById('passwordChangeAlerts');
            ...
            .then(data => {
                if (data.success) {
                    // Show perfectly aligned success message
                    const successAlert = `
                    ...
                    `;
                    alertsContainer.innerHTML = successAlert;
